...
import { SendPaymentMetaMask } from "../../lib/airdropPayment";
...
export default function AirdropPage() {
  ...
  async function payHandler() {
    try {
      if (info.wallet === "metamask") {
        if (info.amount >= 5) {
          setLoading(true);
          const res = await SendPaymentMetaMask(info.amount);
          if (res) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-black to-[#0a0a20] text-white">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24 relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Join our community and receive exclusive tokens as part of our
            launch campaign. Complete simple tasks to increase your allocation.
          </div>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-lg px-6 py-4 transition-all duration-300 shadow-lg shadow-blue-600/20 hover:shadow-blue-700/40 group flex flex-col items-center space-y-2">
                  <span>Pre Book Now</span>
                </Button>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle>Pre-book Recurx tokens 🚀</AlertDialogTitle>
                  <AlertDialogDescription>
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6 p-4">
                      ...
                      <div className="space-y-4 w-full max-w-sm">
                        ...
                        <div className="space-y-1">
                          ...
                          >
                            <option value="">Choose the wallet</option>
                        ...
                        <div>
                          ...
                          >
                            {paymentState
                              ? "Thanks for prebooking Recurx tokens"
                              : loading
                              ? "loading"
                              : "Pay Now"}
                          </Button>
            ...
            >
              <Button
                variant="outline"
                className="border-blue-600 text-blue-400 hover:bg-gray-200 text-lg px-8 py-6 transition-all duration-300 group"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#161a36] p-6 rounded-xl border border-blue-700/30 hover:border-blue-500 transition-all hover:shadow-lg hover:shadow-blue-900/20 group hover:-translate-y-1 duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <Link
                  href="https://linkedin.com/company/cryptoairdrop"
                  target="_blank"
                  rel="noopener noreferrer"
                  passHref
                  className="w-full"
            ...
            <div className="bg-[#161a36] p-6 rounded-xl border border-blue-700/30 hover:border-blue-500 transition-all hover:shadow-lg hover:shadow-blue-900/20 group hover:-translate-y-1 duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-400 mb-4">
                  Join our active community for discussions and support
                </p>
                <Link
                  href="https://t.me/recurxtoken2025"
                  target="_blank"
                  rel="noopener noreferrer"
                  passHref
                  className="w-full"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              If you missed Bitcoin in 2014, then you can rewrite your destiny
              with
                ...
                <ul className="space-y-5">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="text-gray-400">
                      Early adopters made 75,000% returns
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="text-gray-400">
                      Many people missed the opportunity
                    </p>
                  </li>
                </ul>
              </div>
                ...
                <ul className="space-y-5">
                  <li className="flex items-start">
                    ...
                    <p className="text-white">
                      Ground floor opportunity at launch price
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1">
                    ...
                    <p className="text-white">
                      Revolutionary technology with real-world use cases
                    </p>
                  </li>
                  <li className="flex items-start">
                    <div className="mr-3 mt-1">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="text-white">
                      Free tokens available through our airdrop
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <p className="text-gray-300">
                    Join the Recurx revolution today
                  </p>
                </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem
              value="item-1"
              className="bg-[#0d1025] rounded-xl border border-blue-900/50 px-6 shadow-lg shadow-blue-900/10"
            >
              <AccordionTrigger className="text-lg font-medium py-4 hover:text-blue-400 transition-colors">
                What is an airdrop?
              </AccordionTrigger>
              <AccordionContent className="text-gray-300 pb-4">
                An airdrop is a distribution of cryptocurrency tokens to
                multiple wallet addresses, usually for free. Projects use
                airdrops as a marketing strategy to increase awareness and
                adoption.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
            ...
            >
              ...
              <AccordionContent className="text-gray-300 pb-4">
                To claim your tokens, connect your wallet, complete the required
                tasks, and submit your information. Tokens will be distributed
                to eligible participants after the airdrop period ends.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
              value="item-3"
            ...
            >
              ...
              <AccordionContent className="text-gray-300 pb-4">
                Tokens will be distributed within 14 days after the airdrop
                campaign ends. You'll receive a notification email once your
            ...
            >
              ...
              <AccordionContent className="text-gray-300 pb-4">
                No, participation in our airdrop is completely free. You don't
                need to pay any fees to receive tokens. We cover all gas fees
      ...
      <section className="container mx-auto px-4 py-16 relative">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-2xl p-8 md:p-12 text-center border border-blue-700/50 shadow-xl shadow-blue-900/20">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of participants who have already claimed their
            tokens. Limited time offer - airdrop ends soon!
          </p>
          <Link href="/wait-list" passHref>
