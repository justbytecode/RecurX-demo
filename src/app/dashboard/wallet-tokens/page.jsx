        ...
        <div className="lg:col-span-1">
          <Card className="h-full shadow-lg">
            ...
            <CardContent className="space-y-4">
              ...
              >
                <SelectTrigger className="w-full bg-white dark:bg-gray-800 border-2 border-green-200 dark:border-green-700 hover:border-green-300 dark:hover:border-green-600 transition-colors">
