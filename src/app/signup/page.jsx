      ...
      <div className="w-full md:w-1/2 flex items-start md:items-center justify-center p-4 md:p-8 bg-black md:border-l md:border-purple-900/30 min-h-screen">
        <div className="w-full max-w-md py-4 md:py-8 z-40">
          ...
          <Card className="w-full shadow-xl border border-purple-900/20 bg-black/80 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-purple-900/20 mt-9 sm:mt-0 ">
            <CardHeader className="space-y-1 text-center bg-gradient-to-r from-purple-900/80 to-blue-900/80 text-white p-4 border-b border-purple-800/30">
              <div className="flex justify-center mb-2">
                <div className="bg-black/50 p-2 rounded-full border border-purple-500/30">
                  <ShoppingBag className="h-6 w-6 sm:h-8 sm:w-8 text-purple-400" />
                </div>
              </div>
            ...
            <CardContent className="p-3 sm:p-4 pt-5 sm:pt-6 space-y-3">
              <div className="text-center text-xs sm:text-sm text-gray-400 mb-4">
                Sign up to start managing your business with our powerful tools.
              </div>

              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 flex flex-col items-center">
                <div className="space-y-1 sm:space-y-2 w-full">
                  <Label htmlFor="name" className="text-gray-300 flex items-center gap-2 text-sm">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-gray-900/50 border-purple-900/30 text-white focus:border-purple-500 focus:ring-purple-500/20 pl-10 text-sm sm:text-base h-9 sm:h-10"
                    />
                ...
                <div className="space-y-1 sm:space-y-2 w-full">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-gray-900/50 border-purple-900/30 text-white focus:border-purple-500 focus:ring-purple-500/20 pl-10 pr-10 text-sm sm:text-base h-9 sm:h-10"
                    />
                  ...
                  <div className="mt-1 sm:mt-2 w-full">
                    ...
                    <div className="flex justify-between mt-1">
                      <span className={`text-xs font-medium ${strengthColor === "bg-red-500" ? "text-red-500" :
                ...
                <div className="space-y-1 sm:space-y-2 w-full">
                  <Label htmlFor="confirmPassword" className="text-gray-300 flex items-center gap-2 text-sm">
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white h-9 sm:h-11 transition-all duration-200 mt-4 sm:mt-6 text-sm sm:text-base"
                >
                  Create Account
                </Button>
              </form>

              <div className="text-white text-center my-2 text-xs sm:text-sm">
                Already have an account? <span className="text-purple-400 cursor-pointer" onClick={() => { router.push('/signin') }}>Sign in</span> instead.
              </div>
            </CardContent>

            <CardFooter className="px-3 sm:px-4 py-2 sm:py-3 bg-black/50 border-t border-purple-900/30 flex flex-col space-y-1">
